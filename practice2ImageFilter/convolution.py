...
ksize = (3,3)
img_blur = cv2.blur(img_reverso, ksize)
...
plt.subplot(223);plt.imshow(img_yuv);plt.title("Tigre YUVEADO");
plt.subplot(224);plt.imshow(img_blur);plt.title("Tigre toño con cataratas");
